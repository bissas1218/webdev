...
<html>
	<head>
		<title>아파트 전월세 실거래가 데이터삽입</title>
		<meta charset="utf-8" />
...
function submit(lawdCd){
	var form = document.getElementById("aptRentDataInsertFrm");
...
function submitAll(lawdCd){
	...
	var form = document.getElementById("aptRentDataInsertAllFrm");
	var insertDate = document.getElementById("insertDate");
	//alert(insertDate.value+' '+lawdCd);
...
function search(){
	var insertDate = document.getElementById("insertDate");
	location.href = '/aptRentDataInsert?dealYmd=' + insertDate.value;
}
...
<form name="aptRentDataInsertFrm" id="aptRentDataInsertFrm" action="/aptRentDataInsert" method="post" >
<input type="hidden" name="dealYmd" id="dealYmd" />
<input type="hidden" name="lawdCd" id="lawdCd" />
</form>

<form name="aptRentDataInsertAllFrm" id="aptRentDataInsertAllFrm" action="/aptRentDataInsertAll" method="post" >
<input type="hidden" name="dealYmd" id="dealYmd" />
<input type="hidden" name="lawdCd" id="lawdCd" />
</form>
